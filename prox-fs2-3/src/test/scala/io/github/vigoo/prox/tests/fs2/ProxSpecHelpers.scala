...
trait ProxSpecHelpers {
  ...
  def proxTest(label: String)(assertion: ProxFS2[Task] => ZIO[Any, Throwable, TestResult]): Spec[Any, scala.Throwable] = {
    test(label){
  ...
  def withTempFile[A](inner: File => ZIO[Any, Throwable, A]): ZIO[Any, Throwable, A] =
